...
{{- define "mlflowdb.name" -}}
{{- default "mlflowdb" .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- define "mlflowdb.labels" -}}
helm.sh/chart: {{ include "mlflow.chart" . }}
{{ include "mlflowdb.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{- define "mlflowdb.selectorLabels" -}}
app.kubernetes.io/name: {{ include "mlflowdb.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
{{- define "mlflowdb.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "mlflowdb.fullname" .) .Values.serviceAccount.nameDb }}
{{- else }}
