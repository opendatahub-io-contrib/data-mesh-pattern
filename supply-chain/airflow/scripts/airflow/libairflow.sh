...
if [[ -f /opt/app-root/scripts/postgresql-client/libpostgresqlclient.sh ]]; then
    . /opt/app-root/scripts/postgresql-client/libpostgresqlclient.sh
elif [[ -f /opt/app-root/scripts/postgresql-client/libpostgresql.sh ]]; then
    . /opt/app-root/scripts/postgresql-client/libpostgresql.sh
fi
