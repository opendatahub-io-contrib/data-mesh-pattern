...
# 2. Constants defined in this file (environment variables with no default), i.e. APP_ROOT
...
# Airflow paths
export AIRFLOW_BASE_DIR="${APP_ROOT}"
export AIRFLOW_HOME="${AIRFLOW_BASE_DIR}"
export AIRFLOW_BIN_DIR="${AIRFLOW_BASE_DIR}/bin"
...
export AIRFLOW_DATABASE_NAME="${AIRFLOW_DATABASE_NAME:-airflow}"
export AIRFLOW_DATABASE_USERNAME="${AIRFLOW_DATABASE_USERNAME:-airflow}"
